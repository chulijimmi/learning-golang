...
func main() {
	...
	// We expect to get exactly 50,000 operations. Had we used the non-atomic ops++
	// to increment the counter, we’d likely get a different number, changing between runs,
