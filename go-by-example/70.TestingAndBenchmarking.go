...
// For the sake of demonstration, this code is in package main, but it could
// be any package. Testing code typically lives in the same package as the code it tests.
