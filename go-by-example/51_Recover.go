...
// if one of the client connections exhibits a critical error.
// Instead, the server would want to close that connection and continue
// serving other clients. In fact, this is what Go’s net/http does by default for HTTP servers.
package main
...
// function panics, the defer will activate and a recover call within it will catch the panic.
func main() {
